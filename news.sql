...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Pon 08. dub 2019, 14:48
...
(1, 'Samsung nabízí prohnuté monitory', 'Prohnuté či zahnuté monitory už nejsou ani na našem trhu žádná novinka. Jejich řady nyní obohacuje Samsung pomocí třech nových modelů, a to 27\" CF591 a pak dvou modelů CF390 s úhlopříčkami 23,5\" a 27\". Stojí za to?</p><p>Co se týče prohnutých monitorů, pak ty jsou zajímavé především při vyšších úhlopříčkách, což se tedy o 23,5\" panelu moc říci nedá. Zbylé dva modely ale už mají úhlopříčky 27\", což už je lepší a uživatel bude mít díky tomu veškerou zobrazovací plochu lépe viditelnou. Velký prohnutý monitor by měl být také lepší z hlediska hraní, neboť uživatel má mít pocit, že je více obklopen herním světem, než když se dívá na plochou obrazovku. Ale to nemusí všichni vidět stejně.</p><p>Co si tedy Samsung pro nás přichystal? Jsou to monitory CF591 (27 palců) a CF390 (23,5 a 27 palců), jež mají stejné specifikace týkající se panelů a liší se krom výbavy obrazových rozhraní už jen v drobnostech. Všechny mají označení 1800R, čili poloměr zakřivení 1800 mm. Dále tu máme různé funkce, jimž vévodí AMD FreeSync (zde ale na HDMI) zahrnutá také u všech třech modelů a dále tu je režim Eye Saver potlačující vyzařování škodlivého modrého světla. Monitory využívají panely s technologií VA a model CF591 je schopen díky jisté technologii Samsung Active Color Crystal zajistit 119% pokrytí barevného prostoru sRGB. Právě ten by měl tedy nabídnout nejkvalitnější zobrazení barev a také je pro to vybaven daleko bohatější nabídkou rozhraní, kdežto CF390 se musí spokojit s D-Sub a HDMI. Vedle toho má také vestavěny 5W reproduktory. Monitory Samsung CF591 a CF390 budou dostupné od letošního května. CF591 přijde na 9490 Kč s daní, menší CF390 na 5690 Kč a větší pak na 7290 Kč.', '2019-04-05', 1, 'hardware'),
...
(9, 'titul', 'článek', '2019-04-07', 1, 'hardware'),
(10, 'Toto je další testovací článek', 'V tomto článek je pouze tento text, aby šlo vidět, že to funguje.', '2019-04-07', 1, 'programming');
